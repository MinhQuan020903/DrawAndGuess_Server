...
public class EngineIoConfigurator implements WebSocketConfigurer {
    ...
    @Configuration
    @EnableWebSocket
    public static class EngineIoConfigurator implements WebSocketConfigurer {
    ...
    @Controller
    public static class EngineIoHandler implements HandshakeInterceptor, WebSocketHandler {
